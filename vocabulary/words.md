...
| tutor               | 導師                         | 名詞         | ⬜     |
| resident            | 居民                         | 名詞         | ⬜     |
| considerable        | 相當大的                     | 形容詞       | ⬜     |
| emerging            | 新興的                       | 形容詞       | ⬜     |
| cigarette           | 香煙                         | 名詞         | ⬜     |
| lift                | 舉起                         | 動詞         | ⬜     |
| additionally        | 此外、另外                   | 副詞         | ⬜     |
| lively              | 熱鬧的                       | 形容詞       | ⬜     |
| throughout          | 自始至終、全程、遍及         | 介系詞       | ⬜     |
| nod                 | 點頭、打瞌睡                 | 動詞         | ⬜     |
| exhausting          | 累人的                       | 形容詞       | ⬜     |
| external            | 外部的                       | 形容詞       | ⬜     |
| somehow             | 不知為何                     | 副詞         | ⬜     |
| casual              | 隨意的                       | 形容詞       | ⬜     |
| resolution          | 解決 / 解析度 / 決議         | 名詞         | ⬜     |
| beneficial          | 有益的                       | 形容詞       | ⬜     |
| enterprise          | 企業                         | 名詞         | ⬜     |
| gorgeous            | 華麗的                       | 形容詞       | ⬜     |
| vacancy             | 空缺                         | 名詞         | ⬜     |
...
| tempting            | 誘人的                       | 形容詞       | ⬜     |
| retrieval           | 檢索；取回                   | 名詞         | ⬜     |
| moreover            | 此外；而且（正式）           | 副詞         | ⬜     |
| broaden             | 擴大；拓展                   | 動詞         | ⬜     |
| extrovert           | 外向者                       | 名詞         | ⬜     |
| introvert           | 內向者                       | 名詞         | ⬜     |
| general             | 一般的；概略的               | 名詞, 形容詞 | ⬜     |
| entire              | 整個；全部的                 | 形容詞       | ⬜     |
| eagerness           | 熱忱；渴望                   | 名詞         | ⬜     |
| enhanced            | 強化的；提升的               | 形容詞       | ⬜     |
| investigate         | 調查、查明、深入追查原因     | 動詞         | ⬜     |
| backpack            | 背包旅行；背包               | 動詞, 名詞   | ⬜     |
| adequate            | 足夠的；合格的；合乎需要的   | 形容詞       | ⬜     |
| estimation          | 估計；評估                   | 名詞         | ⬜     |
| tourist             | 遊客                         | 名詞         | ⬜     |
| naive               | 天真；缺乏經驗的             | 形容詞       | ⬜     |
| competency          | 能力；勝任度                 | 名詞         | ⬜     |
| embark              | 著手；開始（通常是重要旅程） | 動詞         | ⬜     |
| credential          | 證書；資格                   | 名詞         | ⬜     |
| privileged          | 有特權的                     | 形容詞       | ⬜     |
| pour                | 倒；傾瀉；下大雨             | 動詞         | ⬜     |
| conquer             | 征服；克服                   | 動詞         | ⬜     |
| squeeze             | 擠壓；壓縮                   | 動詞         | ⬜     |
| absence             | 缺席；不存在                 | 名詞         | ⬜     |
| hung                | 懸掛（hang 的過去式）        | 動詞         | ⬜     |
| sandy beach         | 沙灘                         | 名詞         | ⬜     |
| amenities           | 設施；便利設備               | 名詞         | ⬜     |
| comfy               | 舒適的（口語）               | 形容詞       | ⬜     |
| orchestrates        | 協調；編排                   | 動詞         | ⬜     |
| accelerator         | 加速器；促進器               | 名詞         | ⬜     |
| Facility            | 設施、場所、功能             | 名詞         | ⬜     |
| Cooperate           | 合作、配合                   | 動詞         | ⬜     |
| Headquarters        | 總部、總公司                 | 名詞         | ⬜     |
| Remain              | 保持、仍然是、留下           | 動詞         | ⬜     |
| Annual              | 每年的、年度的               | 形容詞       | ⬜     |
| Intend              | 打算、意圖                   | 動詞         | ⬜     |
| Adjust              | 調整、適應                   | 動詞         | ⬜     |
| Committee           | 委員會                       | 名詞         | ⬜     |
| Ambitious           | 有野心的、有抱負的           | 形容詞       | ⬜     |
| Recruit             | 招募/新兵/新成員             | 動詞, 名詞   | ⬜     |
| Volatile            | 不穩定的、易揮發的           | 形容詞       | ⬜     |
| Predict             | 預測、預言                   | 動詞         | ⬜     |
| Domestically        | 在國內、家庭方面             | 副詞         | ⬜     |
| Constraint          | 限制、約束條件               | 名詞         | ⬜     |
| Retrieve            | 取回、(電腦)檢索資料         | 動詞         | ⬜     |
| Explicitly          | 明確地、明白地               | 副詞         | ⬜     |
| Burden              | 負擔、重擔                   | 名詞, 動詞   | ⬜     |
| Spirit              | 精神、靈魂、烈酒             | 名詞         | ⬜     |
| Precious            | 珍貴的、寶貝的               | 形容詞       | ⬜     |
| Dire                | 極其嚴重的、迫切的           | 形容詞       | ⬜     |
| Distract            | 使分心、轉移注意力           | 動詞         | ⬜     |
| swamp               | 沼澤 / 淹沒工作量            | 名詞, 動詞   | ⬜     |
| personalization     | 個性化、個人化               | 名詞         | ⬜     |
| restrain            | 約束、克制                   | 動詞         | ⬜     |
| Attentive           | 專注的、細心的               | 形容詞       | ⬜     |
| Ultimately          | 最終、根本上                 | 副詞         | ⬜     |
| Panel               | 控制面板 / 專家小組          | 名詞         | ⬜     |
| Assuming            | 假設、假定                   | 連接詞, 分詞 | ⬜     |
| Momentum            | 動能、氣勢                   | 名詞         | ⬜     |
| Promising           | 有前途的、有希望的           | 形容詞       | ⬜     |
| Indicate            | 指出、顯示、表明             | 動詞         | ⬜     |
| Campaign            | (行銷/政治)活動 / 戰役       | 名詞, 動詞   | ⬜     |
| Mass                | 大眾、大量 / 質量(物理)      | 名詞, 形容詞 | ⬜     |
| Log                 | 日誌、登錄 / 原木            | 名詞, 動詞   | ⬜     |
| Assist              | 協助、幫助（較正式）         | 動詞, 名詞   | ⬜     |
| Extract             | 提取、萃取 / 精華            | 動詞, 名詞   | ⬜     |
| Adoption            | 採用(新技術) / 領養          | 名詞         | ⬜     |
| Peak                | 頂峰、高峰期                 | 名詞, 形容詞 | ⬜     |
| Dispute             | 爭議、糾紛                   | 名詞, 動詞   | ⬜     |
| Portable            | 可攜帶的、手提的             | 形容詞       | ⬜     |
| Showcase            | 展示、陳列                   | 動詞, 名詞   | ⬜     |
| Unveil              | 揭幕、公佈(新產品)           | 動詞         | ⬜     |
| Attach              | 附加、貼上                   | 動詞         | ⬜     |
...
| 單字                    | 中文意思                 | 詞性         | 已測驗 |
| ----------------------- | ------------------------ | ------------ | ------ |
| bottomless              | 無底的 / 吃到飽          | 形容詞       | ⬜     |
| afloat                  | 浮著、撐著、不沉         | 形容詞       | ⬜     |
| thoughtlessly           | 没心没肺；不加思考地     | 副詞         | ⬜     |
| tryna（trying to 口語） | trying to，口語          | 縮寫         | ⬜     |
| nag                     | 撈叨                     | 動詞         | ⬜     |
| briefcase               | 公事包                   | 名詞         | ⬜     |
| Cheek                   | 臉頰                     | 名詞         | ⬜     |
| Stove                   | 火爐、瓦斯爐             | 名詞         | ⬜     |
| Fridge                  | 冰箱 (Refrigerator 口語) | 名詞         | ⬜     |
| Laundromat              | 自助洗衣店               | 名詞         | ⬜     |
